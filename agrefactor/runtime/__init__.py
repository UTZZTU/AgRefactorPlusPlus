...
_LAZY_EXPORTS = {
    ...
    "CosimStageInputs": (".cosim_stage", "CosimStageInputs"),
    "CosimValidationStageHandler": (".cosim_stage", "CosimValidationStageHandler"),
    "validate_cosim_policy": (".cosim_stage", "validate_cosim_policy"),
