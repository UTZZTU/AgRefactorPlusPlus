...
void des_key_setup(const unsigned char key[], des_key_t schedule, DES_MODE mode)
{
	unsigned int i, j, to_gen, C, D;
	const unsigned int key_rnd_shift[16] = {1,1,2,2,2,2,2,2,1,2,2,2,2,2,2,1};
	const unsigned int key_perm_c[28] = {56,48,40,32,24,16,8,0,57,49,41,33,25,17,
	                             9,1,58,50,42,34,26,18,10,2,59,51,43,35};
	const unsigned int key_perm_d[28] = {62,54,46,38,30,22,14,6,61,53,45,37,29,21,
	                             13,5,60,52,44,36,28,20,12,4,27,19,11,3};
	const unsigned int key_compression[48] = {13,16,10,23,0,4,2,27,14,5,20,9,
